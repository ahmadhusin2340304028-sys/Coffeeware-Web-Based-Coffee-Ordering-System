...
//tangkap user_id edit
if (isset($_POST['id'])) {
    $id = intval($_POST['id']); // sanitasi angka

    $dataUser = query("SELECT * FROM users WHERE user_id = $id");
...
<head>
  <meta charset="UTF-8">
  <title>CoffeeWare Admin | Users</title>
          ...
          <table class="table table-hover small" data-toggle="table" data-search="true" data-pagination="true">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                 <!-- Tombol Edit -->
                <button data-edit_id="<?= $n['user_id'] ?>" 
                  class="btn btn-warning btn-sm rounded-5 tombolEditUser"
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form action="users.php" method="post">
                          ...
                          <input class="form-control mb-2" type="text" name="name" placeholder="Username" id="name">
                          <input class="form-control mb-2" type="email" name="email" placeholder="Email" id="email">
                          <input class="form-control mb-2" type="text" name="nomor" placeholder="+62***********" id="nomor">
                          <div class="modal-footer">
                            <a type="button" class="btn btn-secondary" style="text-decoration: none;" data-bs-dismiss="modal">batal</a>
    ...
    <script>
      $(function(){
        $(document).on('click', '.tombolEditUser', function() {
          ...
          const user_id = $(this).data('edit_id');
